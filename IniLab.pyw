...
class VentanaManager(QMainWindow):
	...
	def __init__(self):
		...
		self.btn_cerrar_config.setIcon(QIcon('recursos/BotonCerrar.png'))
		self.btn_cerrar_calibracion.setIcon(QIcon('recursos/BotonCerrar.png'))
